...
def read_cmsis_header_file(mcu_name):
    return requests.get(compose_cmsis_header_file_url(compose_cmsis_header_file_name(mcu_name)))
...
if __name__ == '__main__':
    ...
    h_file = read_cmsis_header_file(mcuname)
    print(h_file.ok)

    m = re.findall(r'Peripheral_registers_structures(.*?)Peripheral_memory_map', h_file.text, re.MULTILINE | re.DOTALL)
